...
- **Cache with freshness TTL.** Fresh dated caches skip re-extraction; checkpoint partials as you work (Step 7).
...
- Extraction memory stamped with a verification date and fallbacks; BLOCKING GATE run before every write.
