...
Contents of https://docs.docker.com/desktop/features/networking/:
<p>Networking on Docker Desktop | Docker Docs</p>
...
Docker Desktop can use your system’s default proxy settings or custom settings that you configure with Docker Desktop’s proxy setting.
...
* CLI plugins and other tools that use the Docker API directly must be configured separately with the HTTP\_PROXY, HTTPS\_PROXY, and NO\_PROXY environment variables.
