tool: fetch
url: https://raw.githubusercontent.com/ChromeDevTools/chrome-devtools-mcp/main/src/bin/chrome-devtools-mcp-cli-options.ts
date: 2026-08-06
source: fetch

Content type text/plain; charset=utf-8 cannot be simplified to markdown, but here is the raw content:
Contents of https://raw.githubusercontent.com/ChromeDevTools/chrome-devtools-mcp/main/src/bin/chrome-devtools-mcp-cli-options.ts:
/**
 * @license
